...
$workspaceName = "Fabric Workspace - Development"      # The name of the workspace
...
function SetFabricHeaders() {
    ...
    $tenantId = "e3a9d37c-9a36-44b9-92c1-d623ce3a5308"
    $username = "fabric.automation@techtacofriday.com"
    $password = ConvertTo-SecureString "*********" -AsPlainText -Force
    $psCred = New-Object System.Management.Automation.PSCredential($username, $password)
    #Connect-AzAccount | Out-Null
    Connect-AzAccount -Credential $psCred -Tenant $tenantId | Out-Null
